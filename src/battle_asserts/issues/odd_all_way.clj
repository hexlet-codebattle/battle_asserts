...
(def description
  {:en "Given an array of numbers, return an array which contains all the odd numbers in the orginal array, which also have odd indexes. If there is no such numbers, return `[0]`."
   :ru "Дан массив чисел, создайте новый массив, содержащий нечетные числа с нечетными индексами. Если таких чисел нет, то верните `[0]`."})
