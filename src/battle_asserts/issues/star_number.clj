...
(def description
  {:en "Create a function that takes a positive integer and returns the nth \"star number\".
   ...
   :ru "Напишите функцию, которая принимает положительное целое число и возвращает соответствующее \"звездное число\".
        Звездное число - это центральное фигурное число или центральная гексаграмма (шестиконечная звезда), такая как та, на которой играют в китайские шашки.
        Примечание: https://en.wikipedia.org/wiki/Star_number"})
