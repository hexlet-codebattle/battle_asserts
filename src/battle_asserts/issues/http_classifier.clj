...
(def description
  {:en "Return type of provided http status `code`. Checkout examples for types."
   :ru "Верните тип полученного http `code`. В примерах приведены возможные типы кодов."})
...
(defn arguments-generator []
  (gen/tuple (gen/one-of [(gen/choose 100 199)
                          (gen/choose 200 299)
                          (gen/choose 300 399)
                          (gen/choose 400 499)
                          (gen/choose 500 599)])))
