...
(def description
  {:en "For each of 6 coffee cups you buy, you get a 7th cup free. In total, you get 7 cups. Create a function that takes `n` cups bought and return the total number of cups."
   :ru "За каждые 6 купленных кофейных чашек вы получаете 7-ю чашку бесплатно. В общей сложности, вы получаете 7 чашек. Создайте функцию, которая принимает `n` купленных чашек и рассчитывает общее количество чашек."})
