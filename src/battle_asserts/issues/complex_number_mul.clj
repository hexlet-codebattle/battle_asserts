...
(defn solution [[real1 img1] [real2 img2]]
  (letfn [(real-part [pair] (- (* (first (first pair)) (first (last pair))) (* (last (first pair)) (last (last pair)))))
          (imaginary-part [pair] (+ (* (first (last pair)) (last (first pair))) (* (first (first pair)) (last (last pair)))))
