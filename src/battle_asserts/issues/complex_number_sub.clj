...
(def description
  {:en "Implement a function that calculates difference of two complex numbers. Return result as array where first number is real part and second number is imaginary part."
   :ru "Создайте функцию, которая находит разницу между двумя комплексными числами. Верните результат как массив, где первое число - реальная часть, а вторая - мнимая."})
