...
(def description
  {:en "Find all the anagrams in a vector of words.
   ...
   :ru "Найдите все анаграммы в векторе слов.
      Функция должна возвращать вектор векторов, где каждый подвектор - это набор слов которые являеются анаграммой друг к другу.
      Слова без анагармм не должны попадать в результат. Если анаграмм во входящем векторе нет - возвращается подвектор со строкой \"anagrams not found!\""})
